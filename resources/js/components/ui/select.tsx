...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-10 w-full items-center justify-between rounded-md border border-input bg-card px-3 py-2 text-sm shadow-sm shadow-black/5 ring-offset-background transition-colors placeholder:text-muted-foreground hover:border-ring/45 focus:border-ring focus:outline-hidden focus:ring-2 focus:ring-ring/35 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
            className,
        )}
        {...props}
    >
