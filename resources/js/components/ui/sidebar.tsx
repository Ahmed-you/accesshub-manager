    ...
    return (
        <main
            ...
            className={cn(
                ...
                'peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:peer-data-[side=left]:ml-0 lg:peer-data-[variant=inset]:peer-data-[side=right]:mr-0 lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:peer-data-[side=left]:ml-2 lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:peer-data-[side=right]:mr-2 lg:peer-data-[variant=inset]:rounded-xl lg:peer-data-[variant=inset]:shadow-sm',
                className,
            )}
            {...props}
        />
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Comp
                ...
                className={cn(
                    'absolute top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform group-data-[side=left]:right-3 group-data-[side=right]:left-3 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            className={cn(
                'absolute top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform group-data-[side=left]:right-1 group-data-[side=right]:left-1 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0',
                // Increases the hit area of the button on mobile.
                'after:absolute after:-inset-2 md:after:hidden',
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
    <div
        ...
        className={cn(
            'pointer-events-none absolute flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground group-data-[side=left]:right-1 group-data-[side=right]:left-1',
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.ComponentProps<'ul'>>(({ className, ...props }, ref) => (
    <ul
        ...
        className={cn(
            'mx-3.5 flex min-w-0 flex-col gap-1 border-sidebar-border px-2.5 py-0.5 group-data-[side=left]:translate-x-px group-data-[side=left]:border-l group-data-[side=right]:-translate-x-px group-data-[side=right]:border-r',
            'group-data-[collapsible=icon]:hidden',
            className,
        )}
        {...props}
...
>(({ asChild = false, size = 'md', isActive, className, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            data-active={isActive}
            className={cn(
                'flex h-7 min-w-0 items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-hidden ring-sidebar-ring group-data-[side=left]:-translate-x-px group-data-[side=right]:translate-x-px hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground',
